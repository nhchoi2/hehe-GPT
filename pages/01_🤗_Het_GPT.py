...
with st.expander("🔹 사용 방법 예시 보기"):
    st.markdown("""
이 페이지는 **AI 기반 대화형 챗봇**입니다.  
질문을 입력하면 **Hugging Face AI 모델(Gemma-2-9B-it)**이 자연스럽고 전문적인 답변을 제공합니다.  
...
✅ 생활 정보 및 추천  
✅ 특정 주제에 대한 심층 분석  
✅ 그 외 다양한 분야의 AI 기반 답변 제공  

⚠️ **주의:**  
- AI가 제공하는 답변은 참고용이며, 중요한 결정 전에 추가 검토가 필요합니다.  
- AI는 최신 정보를 반영하지 않을 수도 있습니다.  
""")
